...
describe('shouldDeload', () => {
  ...
  describe('performance regression trigger', () => {
    it('returns true when >50% of exercises show >10% regression', () => {
      const snapshots: PerformanceSnapshot[] = [
        { exerciseId: 'ex1', baselineWeight: 100, currentWeight: 85, baselineRpe: 7, currentRpe: 8, sessionsSinceStart: 10 },
        { exerciseId: 'ex2', baselineWeight: 80, currentWeight: 65, baselineRpe: 7, currentRpe: 8.5, sessionsSinceStart: 10 },
        { exerciseId: 'ex3', baselineWeight: 60, currentWeight: 60, baselineRpe: 7, currentRpe: 7.5, sessionsSinceStart: 10 },
      ]
    ...
    it('returns false when <50% of exercises show regression', () => {
      const snapshots: PerformanceSnapshot[] = [
        { exerciseId: 'ex1', baselineWeight: 100, currentWeight: 85, baselineRpe: 7, currentRpe: 8, sessionsSinceStart: 10 },
        { exerciseId: 'ex2', baselineWeight: 80, currentWeight: 79, baselineRpe: 7, currentRpe: 7.5, sessionsSinceStart: 10 },
        { exerciseId: 'ex3', baselineWeight: 60, currentWeight: 59, baselineRpe: 7, currentRpe: 7.5, sessionsSinceStart: 10 },
      ]
  ...
  describe('overreaching trigger', () => {
    it('returns true when all exercises have RPE ≥ 9', () => {
      const snapshots: PerformanceSnapshot[] = [
        { exerciseId: 'ex1', baselineWeight: 100, currentWeight: 100, baselineRpe: 7, currentRpe: 9, sessionsSinceStart: 10 },
        { exerciseId: 'ex2', baselineWeight: 80, currentWeight: 80, baselineRpe: 7, currentRpe: 9.5, sessionsSinceStart: 10 },
        { exerciseId: 'ex3', baselineWeight: 60, currentWeight: 60, baselineRpe: 7, currentRpe: 10, sessionsSinceStart: 10 },
      ]
      expect(shouldDeload(2, snapshots)).toBe(true)
    })
    ...
    it('returns false when some exercises are below RPE 9', () => {
      const snapshots: PerformanceSnapshot[] = [
        { exerciseId: 'ex1', baselineWeight: 100, currentWeight: 100, baselineRpe: 7, currentRpe: 9, sessionsSinceStart: 10 },
        { exerciseId: 'ex2', baselineWeight: 80, currentWeight: 80, baselineRpe: 7, currentRpe: 8, sessionsSinceStart: 10 },
      ]
      expect(shouldDeload(2, snapshots)).toBe(false)
    })
    ...
    it('returns false with fewer than 3 exercises (minimum threshold)', () => {
      const snapshots: PerformanceSnapshot[] = [
        { exerciseId: 'ex1', baselineWeight: 100, currentWeight: 100, baselineRpe: 7, currentRpe: 10, sessionsSinceStart: 10 },
        { exerciseId: 'ex2', baselineWeight: 80, currentWeight: 80, baselineRpe: 7, currentRpe: 9.5, sessionsSinceStart: 10 },
      ]
  ...
  describe('combined triggers', () => {
    it('returns true if any single trigger fires', () => {
      ...
      const snapshots: PerformanceSnapshot[] = [
        { exerciseId: 'ex1', baselineWeight: 100, currentWeight: 80, baselineRpe: 7, currentRpe: 9, sessionsSinceStart: 10 },
        { exerciseId: 'ex2', baselineWeight: 80, currentWeight: 60, baselineRpe: 7, currentRpe: 9.5, sessionsSinceStart: 10 },
        { exerciseId: 'ex3', baselineWeight: 60, currentWeight: 50, baselineRpe: 7, currentRpe: 9, sessionsSinceStart: 10 },
      ]
      expect(shouldDeload(2, snapshots)).toBe(true)
    })
  })
...
describe('applyDeload', () => {
    ...
    const days: WorkoutDay[] = [{
      ...
      exercises: [{
        exercise: {
          ...
          equipment: ['full_gym'], isCompound: true,
        },
        sets: 4,
        reps: 8,
        weight: 100,
    ...
    const days: WorkoutDay[] = [
      {
        ...
        name: 'Push',
        exercises: [{
          exercise: { id: 'ex1', name: 'Bench', muscleGroup: 'chest', equipment: ['full_gym'], isCompound: true },
      ...
      },
      {
        ...
        name: 'Pull',
        exercises: [{
          exercise: { id: 'ex2', name: 'Row', muscleGroup: 'back', equipment: ['full_gym'], isCompound: true },
  ...
  it('handles exercises without weight', () => {
    const days: WorkoutDay[] = [{
      ...
      name: 'Push',
      exercises: [{
        exercise: { id: 'pushup', name: 'Push-up', muscleGroup: 'chest', equipment: ['bodyweight_only'], isCompound: true },
        sets: 3,
        reps: 15,
      }],
    }]
  ...
  it('does not mutate original days', () => {
    const days: WorkoutDay[] = [{
      ...
      name: 'Push',
      exercises: [{
        exercise: { id: 'bench', name: 'Bench', muscleGroup: 'chest', equipment: ['full_gym'], isCompound: true },
        sets: 4, reps: 8, weight: 100,
      }],
    }]
