...
describe('applyPeriodization — DUP', () => {
  ...
  it('cycle 2 shifts toward heavier loads', () => {
    ...
    expect(resultWeek4[0].exercises[0].reps)
      .toBeLessThanOrEqual(resultWeek1[0].exercises[0].reps)
  })
  ...
  it('isolations get higher reps than compounds', () => {
    ...
    expect(result[0].exercises[1].reps)
      .toBeGreaterThan(result[0].exercises[0].reps)
  })
