    ...
    const days: WorkoutDay[] = [
      {
        ...
        exercises: [
          ...
          {
            exercise: {
              id: 'ohp', name: 'OHP', muscleGroup: 'shoulders',
              equipment: ['full_gym'], isCompound: true,
            },
      ...
      },
      {
        ...
        exercises: [
          {
            exercise: {
              id: 'bench2', name: 'Bench', muscleGroup: 'chest',
              equipment: ['full_gym'], isCompound: true,
            },
      ...
      exercises: [
        {
          ...
          sets: 12, reps: 8, // Intermediate MAV is 16, 12 is optimal
        },
      ],
    }]
      ...
      exercises: [
        {
          ...
          sets: 3, reps: 8, // Intermediate MEV is 10, 3 is undertraining
        },
      ],
    }]
