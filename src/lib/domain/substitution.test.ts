...
import { findSubstitute, swapInjuredExercises, isInjuryRestricted, getSuggestions } from './substitution'
import type { Exercise } from './types'

// ─── Fixtures ────────────────────────────────────────────────────────

const exercises: Exercise[] = [
  { id: 'bench', name: 'Bench Press', muscleGroup: 'chest', equipment: ['full_gym'], isCompound: true },
  { id: 'db-press', name: 'DB Bench Press', muscleGroup: 'chest', equipment: ['full_gym', 'home_gym'], isCompound: true },
  { id: 'pushup', name: 'Push-up', muscleGroup: 'chest', equipment: ['bodyweight_only'], isCompound: true },
  { id: 'cable-fly', name: 'Cable Fly', muscleGroup: 'chest', equipment: ['full_gym'], isCompound: false },
  { id: 'pec-deck', name: 'Pec Deck', muscleGroup: 'chest', equipment: ['full_gym'], isCompound: false },

  { id: 'ohp', name: 'Overhead Press', muscleGroup: 'shoulders', equipment: ['full_gym'], isCompound: true },
  { id: 'lateral-raise', name: 'Lateral Raise', muscleGroup: 'shoulders', equipment: ['full_gym', 'home_gym'], isCompound: false },

  { id: 'squat', name: 'Squat', muscleGroup: 'quadriceps', equipment: ['full_gym'], isCompound: true },
  { id: 'leg-press', name: 'Leg Press', muscleGroup: 'quadriceps', equipment: ['full_gym'], isCompound: true },
  { id: 'bodyweight-squat', name: 'Bodyweight Squat', muscleGroup: 'quadriceps', equipment: ['bodyweight_only'], isCompound: true },

  { id: 'pullup', name: 'Pull-up', muscleGroup: 'back', equipment: ['full_gym', 'home_gym'], isCompound: true },
  { id: 'barbell-row', name: 'Barbell Row', muscleGroup: 'back', equipment: ['full_gym'], isCompound: true },
]
